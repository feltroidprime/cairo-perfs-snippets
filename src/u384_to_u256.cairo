...
mod tests {
    ...
    use core::circuit::conversions::{NZ_POW64_TYPED, NZ_POW32_TYPED, POW64_TYPED, POW96_TYPED, upcast, DivRemU96By64,DivRemU96By32};
    use core::circuit::conversions::{AddHelperTo96By32Impl,AddHelperTo128By64Impl,AddHelperTo128By96Impl};
    ...
    fn test_u384_circuit_output_to_u256() {
        ...
        let y = try_into_u256(x);
        assert_eq!(y, Option::Some(u256 { low: 0x836f45e30a666c4bd0b0f6ac7bfc6697, high: 0x55354b07685a19 }));
        ...
        let y = try_into_u256(x);
        assert_eq!(y, Option::Some(u256 { low: 0x7a497f6bf99e6e4a89d4c4bf4eeb5764, high: 0xba69422bccfb0bf0 }));
        ...
        let y = try_into_u256(x);
        assert_eq!(y, Option::Some(u256 { low: 0xf4262ef4a18fd325c835625f53342a9f, high: 0xda3f862f6ff3d3c356 }));
        ...
        assert_eq!(
            y,
            Option::Some(u256 { low: 0x4abd71f14332f4d7188cef59cbdef8db, high: 0x4bb761b32d048bb3e59509bf71bec })
        );
    }
}