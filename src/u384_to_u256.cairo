...
fn test_u384_circuit_output_to_u256() {
    ...
    let x = u384 { limb0: 0x79f59cab560d347406f8f978, limb1: 0x32355e68, limb2: 0x0, limb3: 0x0 };
    let y = try_into_u256(x);
    assert_eq!(y, Option::Some(u256 { low: 0x32355e6879f59cab560d347406f8f978, high: 0x0 }));

    let x = u384 { limb0: 0xf7c12fd7cd43a2091356f287, limb1: 0x5670d3784d, limb2: 0x0, limb3: 0x0 };
    let y = try_into_u256(x);
    ...
    let x = u384 {
        limb0: 0xa666c4bd0b0f6ac7bfc6697, limb1: 0x55354b07685a19836f45e3, limb2: 0x0, limb3: 0x0,
    };
    let y = try_into_u256(x);
    assert_eq!(
        y, Option::Some(u256 { low: 0x836f45e30a666c4bd0b0f6ac7bfc6697, high: 0x55354b07685a19 }),
    );
    ...
    let y = try_into_u256(x);
    assert_eq!(
        y, Option::Some(u256 { low: 0x7a497f6bf99e6e4a89d4c4bf4eeb5764, high: 0xba69422bccfb0bf0 }),
    );
    ...
    assert_eq!(
        y,
        Option::Some(u256 { low: 0xf4262ef4a18fd325c835625f53342a9f, high: 0xda3f862f6ff3d3c356 }),
    );
